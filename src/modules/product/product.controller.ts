...
export class ProductController {
  ...
  async create(@Body() createProductDto: CreateProductDto,@User() user: any) {
    ...
    return {success: true, message: MessageConstant.Product.createdSuccess, data: createdProduct};
  }
  ...
  async update(@Param('id') id: string, @Body() updateProductDto: UpdateProductDto) {
    ...
    return { success: true, message: MessageConstant.Product.updatedSuccess, data: updated };
  }
